...
export function ParentBannerCarousel() {
  ...
  return (
    <Card className="relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
      <div className="relative h-48 md:h-64 bg-gradient-to-r from-orange-500 to-pink-500">
        ...
        <div className="relative z-10 p-6 h-full flex flex-col justify-center text-white">
          ...
          <p className="text-lg mb-4 opacity-90 max-w-2xl">
            Explore Abhivyakti Highlights - Discover the best art courses for your family
          </p>
          {currentBanner.ctaButton && (
            <Button 
              ...
              onClick={() => window.open(currentBanner.ctaButton?.url, '_blank')}
            >
              {currentBanner.ctaButton.text}
            </Button>
          )}
        </div>

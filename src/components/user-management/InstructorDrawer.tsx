...
export function InstructorDrawer({ user, isOpen, onOpenChange, onUserUpdate }: InstructorDrawerProps) {
  ...
  // Mock classes data for the instructor
  const mockClasses = [
    {
      id: '1',
      date: '2024-01-28',
    ...
    },
    {
      ...
      type: 'Group Class',
      instructor: user.name,
      studentName: 'John Doe, Mary Johnson',
      status: 'Completed'
    }
  ]
